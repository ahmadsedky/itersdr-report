...
The Forward Weighted Consistent Adjoint Driven Importance Sampling \gls{fwcadis} method \cite{wagnerNSEFWCADIS} has typically been used to increase the efficiency to Monte Carlo calculations of distributions, such as flux or dose rate distributions (e.g., mesh tallies), as well as responses at multiple localized detectors and spectra. The basis of this method si the development of an importance function that represents the importance of particles to the objective of uniform Monte Carlo particle density in the desired tally regions. Implementation of this method utilizes the results from a forward of generating weight windows is ideal for a global
